        ...
        <div className="density-constellation">
            <div className="density-swarm-wrap">
                <svg
                    ...
                    role="group"
                    tabIndex={0}
                    aria-label={`${points.length} flagged posts by persuasion density. Use arrow keys to inspect each post.`}
            ...
            <p className="density-axis-caption">
                Persuasion density per flagged post — 0 none, 1 wall-to-wall.
            </p>
